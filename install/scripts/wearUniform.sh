...
# Install services
git clone --branch hotday-perform https://github.com/keptn/jenkins-service.git --single-branch
cd jenkins-service
chmod +x deploy.sh
...
git clone --branch hotday-perform https://github.com/keptn/github-service.git --single-branch
cd github-service
chmod +x deploy.sh
./deploy.sh
...
git clone --branch hotday-perform https://github.com/keptn/servicenow-service.git --single-branch
...
git clone --branch hotday-perform https://github.com/keptn/pitometer-service.git --single-branch
